...
d3.csv("data/PRMNDataset.csv", function (data) {
  ...
  d3.json("data/Som_Admbnda_Adm1_UNDP.json", function (regionJson) {
    ...
    //    });
        ...
        var displaceWeekGroup7 = displaceWeek.group()
        .reduceSum(function (d) {
          return +d.yr2022;
        });
        ...
        var displaceWeekGroup9 = displaceWeek.group()
        .reduceSum(function (d) {
         return +d.yr2024;
        });
      ...
      displaceWeekChart
        ...
        .compose([
          ...
          dc.lineChart(displaceWeekChart)
            ...
            //   return +d.key.substr(4,6);
            // })
            .colors('#000000') // black #000000
            .dashStyle([3,2])
            .group(displaceWeekGroup6, "2024")
            .useRightYAxis(true),
          dc.lineChart(displaceWeekChart)
            .dimension(displaceWeek)
            // .keyAccessor(function(d){
            ...
            //   return +d.key.substr(4,6);
            // })
            .colors('#dce30b') // Yellow #dce30b
            .group(displaceWeekGroup8, "2026")
            // .useRightYAxis(true)
        ]) 
